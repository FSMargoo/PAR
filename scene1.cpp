...
int main() {
    ...
    std::vector<BoxData> boxes = {
        BoxData{
            .leftTop = {308.f / 800.f, 172.f / 800.f},
            .rightBottom = {(308.f + 183.f) / 800.f, (172.f + 41.f) / 800.f},
            .color = glm::vec3(0.8470588235294118, 0.25098039215686274, 0.25098039215686274),
            .isLight = true
        },
        BoxData{
            .leftTop = {308.f / 800.f, 606.f / 800.f},
            .rightBottom = {(308.f + 183.f) / 800.f, (606.f + 41.f) / 800.f},
            .color = glm::vec3(0.5568627450980392, 0.08627450980392157, 0.08627450980392157),
            .isLight = true
        },
        BoxData{
            .leftTop = {607.f / 800.f, 331.f / 800.f},
            .rightBottom = {(607.f + 41.f) / 800.f, (331.f + 138.f) / 800.f},
            .color = glm::vec3(0.9333333333333333, 0.9333333333333333, 0.9333333333333333),
            .isLight = true
        },
        BoxData{
            .leftTop = {152.f / 800.f, 331.f / 800.f},
            .rightBottom = {(152.f + 41.f) / 800.f, (331.f + 138.f) / 800.f},
            .color = glm::vec3(0.5568627450980392, 0.08627450980392157, 0.08627450980392157),
            .isLight = false
        },
    };
    ...
    std::vector<CircleData> circles = {
        CircleData{
            .center = {400.f / 800.f, 400.f / 800.f},
            .radius = {0.03, 0.03},
